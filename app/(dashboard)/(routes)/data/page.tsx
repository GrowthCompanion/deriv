...
import { BarChartBig, DatabaseIcon, MessageCircle, PlaneIcon, ShieldCheckIcon } from "lucide-react";
  ...
  return (
    <div>
      <Heading
        ...
        description="Analyse your referral performances with AI agents."
        icon={BarChartBig}
        iconColor="text-brown-700"
        bgColor="bg-brown-700/10"
      />
      <div className="px-4 lg:px-8">
        ...
        <div style={{ height: "80vh" }}>
          ...
          <iframe
             src="https://data-der.streamlit.app/?embed=true"// Update the src with your desired URL
