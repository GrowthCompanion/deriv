...
import { CameraIcon, DatabaseIcon, FileBadgeIcon, MessageCircle, PlaneIcon } from "lucide-react";
  ...
  return (
    <div>
      <Heading
        ...
        description="Upload your ID proof and Click a Selfie to complete verification."
        icon={CameraIcon}
      ...
      <div className="px-4 lg:px-8">
        ...
        <div style={{ height: "80vh" }}>
          ...
          <iframe
             src="https://photoid.streamlit.app/?embed=true"// Update the src with your desired URL
