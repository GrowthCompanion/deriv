...
import { DatabaseIcon, MessageCircle, PlaneIcon, ThermometerSunIcon, UsersIcon } from "lucide-react";
  ...
  return (
    <div>
      <Heading
        ...
        description="Learn more about the Deriv Platform by chatting with agent."
        icon={UsersIcon}
      ...
      <div className="px-4 lg:px-8">
        ...
        <div style={{ height: "80vh" }}>
          ...
          <iframe
             src="https://chat-der.streamlit.app/?embed=true"// Update the src with your desired URL
